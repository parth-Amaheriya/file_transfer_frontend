  ...
  return (
    <div className="flex h-full min-h-0 w-full flex-col">
      ...
      <div
        ...
        className="flex-1 min-h-0 overflow-y-auto px-2 py-3 scrollbar-thin"
      >
        <div className="space-y-3">
          {visibleMessages.map((msg, index) => {
            const isYou = msg.sender === "you";
      ...
      {/* ✅ INPUT */}
      <div className="flex-shrink-0 border-t px-2 py-2">
        <div className="flex items-center gap-3 rounded-full border px-3 py-2">
          ...
          <Button
            onClick={send}
            className="h-10 w-10 rounded-full bg-orange-500 p-0"
          >
